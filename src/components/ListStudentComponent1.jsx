...
class ListStudentComponent extends Component {
    ...
    render() {
        ...
        return (
            <div>
                 <h2 className="text-center">Lista Studenti</h2>
                 <div className = "row">
                    <button className="btn btn-primary" onClick={this.addStudent}> Adauga Student</button>
                 </div>
                            ...
                            <tbody>
                                {
                                    this.state.students.map(
                                        ...
                                        <tr key = {student.id}>
                                             ...
                                             <td> {student.adresaName}</td>

                                             <td> {student.emailId}</td>
                                             <td> {student.departamentName}</td>
                                            <td> {student.projectName}</td>
                                            <td> {student.cevaName}</td>
                                             <td>
